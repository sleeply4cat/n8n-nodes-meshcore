...
export const eventOptions: INodePropertyOptions[] = [
	...
	{ name: 'New Advert', value: 'advert', description: 'An advert was received (auto-add mode)' },
	{ name: 'New Advert (Manual Add)', value: 'newAdvert', description: 'An advert was received (manual-add mode)' },
